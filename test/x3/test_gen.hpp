...
#if !defined(BOOST_SPIRIT_X3_GEN_TEST_FEB_23_2007_1221PM)
#define BOOST_SPIRIT_X3_GEN_TEST_FEB_23_2007_1221PM
...
namespace spirit_test
{
    ...
    inline bool test_gen(Char const *expected, Generator const& g)
    {
        typedef std::basic_string<Char> string_type;

        string_type generated;
        std::back_insert_iterator<string_type> outit(generated);
        bool result = boost::spirit::x3::generate(outit, g);
    ...
    template <typename Char, typename Generator>
    inline bool test_gen(std::basic_string<Char> const& expected, Generator const& g)
    {
        typedef std::basic_string<Char> string_type;
        ...
        Attribute const &attrib)
    {
        ...
        string_type generated;
        std::back_insert_iterator<string_type> outit(generated);
        bool result = boost::spirit::x3::generate(outit, g, attrib);
    ...
    // inline bool 
    // binary_test_gen(char const *expected, std::size_t size, 
    //     Generator const& g)
    // {
    //     namespace karma = boost::spirit::karma;
    //     typedef std::basic_string<char> string_type;
...
#endif // !BOOST_SPIRIT_X3_GEN_TEST_FEB_23_2007_1221PM
